...
static const char* date = "$Date: 2013-12-17 14:33:48 +0000 (Tue, 17 Dec 2013) $";
static const char* url  = "$HeadURL: svn+ssh://astrometry.net/svn/tags/tarball-0.46/astrometry/util/svn.c $";
static const char* rev  = "$Revision: 24247 $";
